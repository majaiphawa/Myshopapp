...
import 'package:my_shopapp/providers/product.dart';
...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndSetProducts() async {
    final url = Uri.parse(
        'https://shopapp-66195-default-rtdb.firebaseio.com/products.json');
    try {
  ...
  Future<void> updateProduct(String id, Product newProduct) async {
    ...
    if (prodIndex >= 0) {
      final url = Uri.parse(
          'https://shopapp-66195-default-rtdb.firebaseio.com/products/$id.json');
  ...
  void deleteProduct(String id) {
    final url = Uri.parse(
        'https://shopapp-66195-default-rtdb.firebaseio.com/products/$id');
